...
export default function SourceCard() {
  return (
    <div className='source_card__container'>
          <h6>How data poisoning attacks work How data poisoning attacks work</h6>
        <div className='source_link__details'>
            <span>
                  <svg fill="#eff7ff9c" width="16px" height="16px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
